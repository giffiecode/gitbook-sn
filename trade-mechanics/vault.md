...
\
The Vault acts as the protocol’s counterparty for each market. It absorbs net imbalances between longs and shorts and captures protocol fees to incentivize its reserves.&#x20;
...
1. **Fee Income** — LPs receive a proportional share of all trading and settlement fees generated in their market. In the early phase, 100% fees are directed to the vault.&#x20;
