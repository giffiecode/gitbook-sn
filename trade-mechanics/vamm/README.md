---
description: >-
  Supernova virtual AMM lets users swap variable interest-rate exposure for
  fixed-rate exposure. This section is a technical overview of how Supernova
  vAMM facilitates fixed for float swaps.
---
